...
\begin{frontmatter}
    \title{Laboratorio de Fenómenos Colectivos \\ Agua al medio ambiente} \\
...
\end{frontmatter}
\section{¿Qué sucede en cada caso?}

\textbf{i. Caso de un recipiente abierto}: por qué el agua está más fría que la temperatura ambiental. 
...
\textbf{ii. Caso de un recipiente cerrado}: por qué el agua alcanza la temperatura ambiental, cuando el recipiente está cerrado (pero no adiabático), se elimina la posibilidad de evaporación. En este caso, los únicos mecanismos de transferencia de calor son:\\
...
\section{Influencia del material del recipiente}
...
\subsection{Lo que sucede en cada subcaso}
En un recipiente abierto:\\
